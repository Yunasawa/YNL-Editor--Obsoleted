...
{
    public class EInteractableAssetField<T> : Button where T : UnityEngine.Object
    {
        ...
        public EInteractableAssetField() : base()
        {
        ...
        {
            var element = evt.currentTarget as EInteractableAssetField<T>;
            action?.Invoke();
