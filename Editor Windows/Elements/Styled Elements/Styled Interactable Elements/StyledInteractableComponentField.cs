...
{
    public class StyledInteractableComponentField<T> : Button where T : UnityEngine.Object
    {
        ...
        public StyledInteractableComponentField() : base()
        {
        ...
        {
            var element = evt.currentTarget as StyledInteractableComponentField<T>;
            action?.Invoke();
