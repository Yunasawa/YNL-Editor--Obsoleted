...
{
    public class EToggleField : VisualElement
    {
        private const string _styleSheet = "Style Sheets/Elements/Plained/EToggleField";

        public Toggle Field;
        private VisualElement LabelField;
        private VisualElement Checkmark;

        public EToggleField(SerializedProperty serializedObject) : base()
        {
