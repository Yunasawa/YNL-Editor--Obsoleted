...
{
    public class EEnumField : VisualElement
    {
        private const string _styleSheet = "Style Sheets/Elements/Plained/EEnumField";

        public EnumField Field;
        private VisualElement LabelField;
        private VisualElement EnumField;

        public EEnumField(SerializedProperty serializedObject, string name) : base()
        {
