...
{
    public class ETextField : VisualElement
    {
        private const string _styleSheet = "Style Sheets/Elements/Plained/EIntField";

        public TextField Field;
        private VisualElement LabelField;
        private VisualElement InputField;

        public ETextField(SerializedProperty serializedObject) : base()
        {
