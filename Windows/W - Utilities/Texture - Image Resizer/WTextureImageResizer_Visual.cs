...
namespace YNL.Editor.Window.Texture.ImageResizer
{
    public class WTextureImageResizer_Visual : VisualElement
    {
        ...
        private const string _windowIcon = "Assets/Plugins/Yunasawa の Library/YのL - Editor/Textures/Windows/Texture Center/Image Resizer Icon.png";
        ...
        #endregion
        #region ▶ Style Sheets
        private const string _uss_Main = "Assets/Plugins/Yunasawa の Library/YのL - Editor/Windows/W - Utilities/Texture - Image Resizer/WTextureImageResizer.uss";
        #endregion
